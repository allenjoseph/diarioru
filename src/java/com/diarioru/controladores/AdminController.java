...
import com.diarioru.servicios.SprintServiceInterface;
...
public class AdminController {
    ...
    public ModelAndView spring() {
        ...
        Helper.agregarUsuario(modelo);
        modelo.addObject("sprint", sprintService.obtenerSprint());
        return modelo;
    }
    ...
    @RequestMapping(value = "/listar-sprints.html")
    public ModelAndView listarsprints(){
        ModelAndView modelo = new ModelAndView("ListarSprints");
        Helper.agregarUsuario(modelo);
        modelo.addObject("sprints", sprintService.listarSprints());
        return modelo;
    } 
